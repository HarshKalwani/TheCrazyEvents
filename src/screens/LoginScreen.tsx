...
const LogoUrl =
  'https://static.vecteezy.com/system/resources/thumbnails/020/120/648/small/crazy-text-effect-lettering-design-vector.jpg';
    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      >
        ...
        >
          ...
          <Text className="text-center text-gray-400 my-3 font-medium">
            OR{' '}
          </Text>
